...
funcp funcTab[2] = {(funcp)execute_8, (funcp)vhdl_transfunc_eventcallback};
const int NumRelocateId= 2;

void relocate(char *dp)
{
	iki_relocate(dp, "xsim.dir/Main_behav/xsim.reloc",  (void **)funcTab, 2);
	iki_vhdl_file_variable_register(dp + 2056);
	iki_vhdl_file_variable_register(dp + 2112);
